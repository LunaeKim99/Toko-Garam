    ...
    <div class="container-custom">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6 lg:gap-8">
            @forelse($productVariants as $index => $variant)
                <div id="{{ $variant['id'] }}" class="group bg-[var(--surface)] dark:bg-[var(--surface)] rounded-xl shadow-sm-aj hover:shadow-xl-aj transition-all duration-300 border border-[var(--border)] overflow-hidden"
