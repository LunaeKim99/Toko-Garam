...
<form action="{{ route('admin.company-profile.update') }}" method="POST" enctype="multipart/form-data" class="bg-white p-6 lg:p-8 rounded-xl shadow-sm border border-gray-200 max-w-3xl">
    @csrf
    @method('PUT')
    ...
    <div class="space-y-5">
        ...
        <div>
            <label class="block text-sm font-medium text-dark mb-1.5">Logo (opsional)</label>
