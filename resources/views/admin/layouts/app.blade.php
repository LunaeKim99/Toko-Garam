...
<body class="bg-gray-50 dark:bg-slate-950 font-sans antialiased transition-colors duration-300" x-data>
    <div class="w-full min-h-screen">
        ...
        <div class="flex-1 md:ml-64">
            <nav class="bg-white shadow-sm border-b border-gray-200 h-16 flex items-center px-4 md:px-6 sticky top-0 z-20 dark:bg-slate-900 dark:border-slate-800">
                <div class="flex items-center justify-between w-full">
                    <div class="flex items-center gap-4">
                        ...
                        <div class="hidden md:block">
                            <h1 class="text-xl font-bold text-dark dark:text-slate-100">@yield('title', 'Dashboard')</h1>
                            <p class="text-sm text-gray-500 dark:text-slate-400">@yield('subtitle', 'Kelola website Garam Nusantara')</p>
                        </div>
                    </div>
...
<div class="text-right hidden sm:block">
                             ...
                             <p class="text-xs text-gray-500 dark:text-slate-400">Administrator</p>
                         </div>
            ...
            <footer class="bg-white border-t border-gray-200 py-4 px-4 sm:px-6 lg:px-8 mt-8 dark:bg-slate-900 dark:border-slate-800">
                <div class="flex flex-col sm:flex-row justify-between items-center gap-4">
                    <p class="text-sm text-gray-500 dark:text-slate-400">© {{ date('Y') }} Garam Nusantara Jepara. Admin Panel v1.0</p>
