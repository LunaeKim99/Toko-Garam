            ...
            <div class="swiper-wrapper pb-12">
                ...
                @foreach($testimonials as $testimonial)
                    <div class="swiper-slide">
                        <div class="bg-white dark:bg-slate-900 p-6 rounded-xl shadow-sm border border-light-gray dark:border-slate-800 h-full transition-colors duration-300">
                            <i data-lucide="quote" class="w-8 h-8 text-primary/20 mb-3"></i>
                            <p class="text-gray-600 dark:text-slate-300 text-sm leading-relaxed mb-4 transition-colors duration-300">"{{ $testimonial['text'] }}"</p>
                            ...
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    <div class="font-medium text-dark dark:text-slate-100 text-sm transition-colors duration-300">{{ $testimonial['name'] }}</div>
                                    <div class="text-xs text-gray-400 dark:text-slate-500 transition-colors duration-300">{{ $testimonial['role'] }}</div>
                                </div>
                            </div>
                        </div>
                    </div>
