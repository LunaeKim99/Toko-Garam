<section class="section-padding bg-light" id="lokasi">
    <div class="container-custom">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 mt-12">
            <div class="bg-white p-6 lg:p-8 rounded-xl shadow-sm border border-light-gray" data-aos="fade-right">
            ...
            <div class="rounded-xl overflow-hidden shadow-sm border border-light-gray h-72" data-aos="fade-left">
                <iframe
