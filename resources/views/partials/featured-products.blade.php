<section class="section-padding dark:bg-[#020617] transition-colors duration-300">
    <div class="container-custom">
        ...
        <div class="max-w-4xl mx-auto" data-aos="fade-up">
            @if($product)
            <a href="{{ route('product') }}" class="group block bg-white dark:bg-[#0F172A] rounded-xl shadow-sm hover:shadow-lg transition-all duration-300 overflow-hidden border border-light-gray dark:border-[#1E293B]">
                <div class="grid grid-cols-1 md:grid-cols-2">
                    ...
                    <div class="p-6 lg:p-8 flex flex-col justify-center">
                        ...
                        <h3 class="text-xl lg:text-2xl font-bold text-dark dark:text-white mb-3 transition-colors duration-300">{{ $product?->nama }}</h3>
                        <p class="text-gray-500 dark:text-gray-400 text-sm leading-relaxed mb-4 transition-colors duration-300">{{ Str::limit($product?->deskripsi, 150) }}</p>
